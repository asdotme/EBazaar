...
public class DbClassCatalogTypes implements IDbClassCatalogTypes {
    ...
    /* (non-Javadoc)
	 * @see business.productsubsystem.IDbClassCatalogTypes#getCatalogTypes()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see business.productsubsystem.IDbClassCatalogTypes#getQuery()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see business.productsubsystem.IDbClassCatalogTypes#getQueryParams()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see business.productsubsystem.IDbClassCatalogTypes#getParamTypes()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see business.productsubsystem.IDbClassCatalogTypes#populateEntity(java.sql.ResultSet)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see business.productsubsystem.IDbClassCatalogTypes#getDbUrl()
	 */
    @Override
