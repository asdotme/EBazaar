...
public class BrowseAndSelectController {
	...
	/**
	 * TODO : Saving a live cart
	 *  Saving a LiveCart
	 * @param shopCartSS
	 * @param custIsLoggedIn
	 * @throws BackendException
	 */
	public void saveLiveCart(ShoppingCartSubsystem shopCartSS, boolean custIsLoggedIn) throws BackendException {
		// Saving the live cart
		if(custIsLoggedIn) 
...
//end new
	...
	public int getquantityAvailable(ProductSubsystem productSub,Product product) throws BackendException{		
		return productSub.readQuantityAvailable(product);
	}
