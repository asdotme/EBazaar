...
public enum BrowseSelectData  {
	...
	public int quantityAvailable(Product product) throws BackendException {
		...
		//int quantity = DefaultData.DEFAULT_QUANTITY_AVAILABLE; 
		
		/**
		 *  This should be replace to the call to the appropriate SubSystem
		 *  What is the Subsystem? Answer : The ProductSubSystem
		 *  
		 */
      //ProductSubsystem productSubSystem = new ProductSubsystemFacade();
      ProductSubsystem prodSS = (ProductSubsystemFacade)Start.ctx.getBean("pss");
	  return controller.getquantityAvailable(prodSS,getSelectedProduct().getProduct());		//
