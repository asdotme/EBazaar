...
public enum CheckoutData {
	...
	public Address getDefaultShippingData() {
			return CacheReader.readCustomer().getDefaultShippingAddress();
	}
	
	public Address getDefaultBillingData() {
		return CacheReader.readCustomer().getDefaultBillingAddress();
	}
	
	public List<String> getDefaultPaymentInfo() {
		CreditCard cc=CacheReader.readCustomer().getDefaultPaymentInfo();
		return Arrays.asList(cc.getNameOnCard(),cc.getCardNum(),cc.getCardType(),cc.getExpirationDate());
	}
